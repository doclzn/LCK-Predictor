...
spec=importlib.util.spec_from_file_location("v15",ROOT/"server.py")
...
print("V15 Draft Tree test: OK")
print("runtime_sec",round(elapsed,2))
print("states",tree["model_states_evaluated"])
print("top_pick",tree["results"][0]["root_action"]["champion"])
print("robust",round(tree["results"][0]["minimax_probability_root"],4))
print("flex_assignments",flex["assignment_count"])
